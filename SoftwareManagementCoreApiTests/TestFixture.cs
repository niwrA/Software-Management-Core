...
namespace SoftwareManagementCoreApiTests
{
  ...
  public class TestFixture<TStartup> : IDisposable
  {
    ...
    internal void AddContactStateReadOnlyRepository<T>() where T: class, IContactStateReadOnlyRepository
    {
      _services.AddTransient<IContactStateReadOnlyRepository, T>();
    }
